...
export default function RegisterBuyer() {
  ...
  const obrigatoriosOk = DOC_TIPOS_BUYER.filter((t) => t.obrigatorio).every((t) => docEnviado(t.value));
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex">
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="flex items-center gap-2 mb-5 text-sm text-muted-foreground">
            ...
            <span className="flex items-center gap-1.5 text-gray-700 font-medium">
              <Building2 size={14} className="text-blue-600" /> Comprador
            </span>
          </div>
          ...
          <Card className="border-border shadow-sm">
            <CardHeader>
              <CardTitle className="text-2xl">{step === 1 ? "Cadastro de Comprador" : "Documentos da empresa"}</CardTitle>
              <CardDescription>
                {step === 1 ? "Preencha os dados da sua empresa" : "Envie os documentos para análise e aprovação do cadastro"}
              </CardDescription>
            </CardHeader>
              ...
              {step === 2 && (
                <div className="space-y-5">
                  ...
                  <div className="bg-gray-50 rounded-xl p-3 text-xs text-muted-foreground">
                    <span className="font-medium">Documentos enviados:</span> {documentos.length} de {DOC_TIPOS_BUYER.length} disponíveis
                    {documentos.length > 0 && (
      ...
      <div className="hidden lg:flex w-[380px] bg-gradient-to-br from-blue-600 to-blue-800 items-center justify-center p-12">
        <div className="text-white text-center">
          <div className="text-7xl mb-6">🏗️</div>
          <h2 className="text-2xl font-black mb-4 leading-tight">Cadastro de Comprador</h2>
          <div className="flex flex-col gap-3 mt-6">
            {["Preços exclusivos PJ", "Compra em volume com desconto", "Cotação direta com fornecedores", "Histórico completo de pedidos"].map((f) => (
